    ...
    artists: [
        {
            id: 'lana-del-rey',
            name: 'Lana Del Rey',
            image: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/assets/artists/lanadelrey/lanadelrey.jpg',
            albums: [
                {
                    id: 'honeymoon',
                    name: 'Honeymoon',
                    year: '2015', // Adicionado ano para demonstração
                    cover: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/assets/albums/lanadelrey/honeymoon/honeymoon.jpg',
                    tracks: [
                        { id: 1, title: '24', duration: '4:55', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Lana Del Rey/Honeymoon/24.mp3' },
                        { id: 2, title: 'Art Deco', duration: '4:55', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Lana Del Rey/Honeymoon/Art Deco.mp3' },
                        { id: 3, title: 'Burnt Norton (Interlude)', duration: '1:21', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Lana Del Rey/Honeymoon/Burnt Norton (Interlude).mp3' },
                        { id: 4, title: 'Don t Let Me Be Misunderstood' , duration: '3:01', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Lana Del Rey/Honeymoon/Don t Let Me Be Misunderstood.mp3' },
                        { id: 5, title: 'God Knows I Tried', duration: '4:40', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Lana Del Rey/Honeymoon/God Knows I Tried.mp3' },
                        { id: 6, title: 'LANA DEL REY - HONEYMOON', duration: '5:54', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Lana Del Rey/Honeymoon/LANA DEL REY - HONEYMOON.mp3' },
                        { id: 7, title: 'Lana Del Rey - Freak', duration: '10:52', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Lana Del Rey/Honeymoon/Lana Del Rey - Freak.mp3' },
                        { id: 8, title: 'Lana Del Rey - High By The Beach (Official Audio)', duration: '4:18', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Lana Del Rey/Honeymoon/Lana Del Rey - High By The Beach (Official Audio).mp3' },
                        { id: 9, title: 'Lana Del Rey - High By The Beach', duration: '4:57', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Lana Del Rey/Honeymoon/Lana Del Rey - High By The Beach.mp3' },
                        { id: 10, title: 'Lana Del Rey - Music To Watch Boys To', duration: '4:54', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Lana Del Rey/Honeymoon/Lana Del Rey - Music To Watch Boys To.mp3' },
                        { id: 11, title: 'Lana Del Rey - Terrence Loves You (Official Audio)', duration: '4:51', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Lana Del Rey/Honeymoon/Lana Del Rey - Terrence Loves You (Official Audio).mp3' },
                        { id: 12, title: 'Religion', duration: '5:23', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Lana Del Rey/Honeymoon/Religion.mp3' },
                        { id: 13, title: 'Salvatore', duration: '4:41', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Lana Del Rey/Honeymoon/Salvatore.mp3' },
                        { id: 14, title: 'Swan Song', duration: '5:23', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Lana Del Rey/Honeymoon/Swan Song.mp3' },
                        { id: 15, title: 'The Blackest Day', duration: '6:05', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Lana Del Rey/Honeymoon/The Blackest Day.mp3' },
                    ]
                },
            ]
        },
        {
            id: 'linkin-park',
            name: 'Linkin Park',
            image: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/assets/artists/Linkin Park/LinkinPark.jpg',
            albums: [
                {
                    id: 'hybrid-theory',
                    name: 'Hybrid Theory',
                    year: '2000', // Adicionei um ano para consistência
                    cover: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/assets/albums/Linkin Park/Hybrid Theory/HybridTheory.jpg',
                    tracks: [
                        { id: 1, title: 'A Place for My Head', duration: '3:04', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Linkin Park/Hybrid Theory/A Place for My Head.mp3' },
                        { id: 2, title: 'By Myself', duration: '3:09', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Linkin Park/Hybrid Theory/By Myself.mp3' },
                        { id: 3, title: 'Crawling', duration: '3:28', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Linkin Park/Hybrid Theory/Crawling.mp3' },
                        { id: 4, title: 'Cure for the Itch', duration: '2:37', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Linkin Park/Hybrid Theory/Cure for the Itch.mp3' },
                        { id: 5, title: 'Forgotten', duration: '3:14', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Linkin Park/Hybrid Theory/Forgotten.mp3' },
                        { id: 6, title: 'High Voltage', duration: '3:45', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Linkin Park/Hybrid Theory/High Voltage.mp3' },
                        { id: 7, title: 'In the End', duration: '3:36', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Linkin Park/Hybrid Theory/In the End.mp3' },
                        { id: 8, title: 'Linkin Park - Runaway', duration: '3:03', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Linkin Park/Hybrid Theory/Linkin Park - Runaway.mp3' },
                        { id: 9, title: 'One Step Closer', duration: '2:37', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Linkin Park/Hybrid Theory/One Step Closer.mp3' },
                        { id: 10, title: 'Papercut', duration: '3:04', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Linkin Park/Hybrid Theory/Papercut.mp3' },
                        { id: 11, title: 'Points of Authority', duration: '3:20', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Linkin Park/Hybrid Theory/Points of Authority.mp3' },
                        { id: 12, title: 'Pushing Me Away', duration: '3:11', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Linkin Park/Hybrid Theory/Pushing Me Away.mp3' },
                        { id: 13, title: 'With You', duration: '3:23', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Linkin Park/Hybrid Theory/With You.mp3' },
                    ]
                },
            ]
        },
        {
            id: 'metallica',
            name: 'Metallica',
            image: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/assets/artists/Metallica/Metallica.jpg', // Corrigido o espaço no nome da imagem
            albums: [
                {
                    id: 'reload',
                    name: 'Reload',
                    year: '2020',
                    cover: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/assets/albums/Metallica/Reload/Reload.jpg',
                    tracks: [
                        { id: 1, title: 'Attitude', duration: '5:16', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Metallica/Reload/Attitude.mp3' },
                        { id: 2, title: 'Bad Seed', duration: '4:05', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Metallica/Reload/Bad Seed.mp3' },
                        { id: 3, title: 'Better Than You', duration: '5:21', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Metallica/Reload/Better Than You.mp3' },
                        { id: 4, title: 'Carpe Diem Baby', duration: '6:12', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Metallica/Reload/Carpe Diem Baby.mp3' },
                        { id: 5, title: 'Devil s Dance', duration: '5:18', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Metallica/Reload/Devil s Dance.mp3' },
                        { id: 6, title: 'Fixxxer', duration: '8:15', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Metallica/Reload/Fixxxer.mp3' },
                        { id: 7, title: 'Low Man s Lyric', duration: '7:37', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Metallica/Reload/Low Man s Lyric.mp3' },
                        { id: 8, title: 'Metallica： Fuel (Official Music Video)', duration: '4:37', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Metallica/Reload/Metallica： Fuel (Official Music Video).mp3' },
                        { id: 9, title: 'Metallica： The Memory Remains (Official Music Video)', duration: '4:38', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Metallica/Reload/Metallica： The Memory Remains (Official Music Video).mp3' },
                        { id: 10, title: 'Metallica： The Unforgiven II (Official Music Video)', duration: '6:36', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Metallica/Reload/Metallica： The Unforgiven II (Official Music Video).mp3' },
                        { id: 11, title: 'Prince Charming', duration: '6:05', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Metallica/Reload/Prince Charming.mp3' },
                        { id: 12, title: 'Slither', duration: '5:13', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Metallica/Reload/Slither.mp3' },
                        { id: 13, title: 'Where The Wild Things Are', duration: '6:54', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Metallica/Reload/Where The Wild Things Are.mp3' },
                    ]
                },
            ]
        },
        {
            ...
            image: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/assets/artists/twenty one pilots/twenty one pilots.jpg',
            albums: [
                {
                    id: 'blurryface',
                    name: 'blurryface',
                    year: '2017',
                    cover: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/assets/albums/twenty one pilots/blurryface/blurryface.jpg',
                    tracks: [
                        { id: 1, title: 'Doubt', duration: '3:11', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/twenty one pilots/blurryface/Doubt.mp3' },
                        { id: 2, title: 'Fairly Local', duration: '3:27', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/twenty one pilots/blurryface/Fairly Local.mp3' },
                        { id: 3, title: 'Goner', duration: '3:56', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/twenty one pilots/blurryface/Goner.mp3' },
                        { id: 4, title: 'Heavydirtysoul', duration: '3:54', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/twenty one pilots/blurryface/Heavydirtysoul.mp3' },
                        { id: 5, title: 'Hometown', duration: '3:54', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/twenty one pilots/blurryface/Hometown.mp3' },
                        { id: 6, title: 'Lane Boy', duration: '4:13', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/twenty one pilots/blurryface/Lane Boy.mp3' },
                        { id: 7, title: 'Message Man', duration: '4:00', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/twenty one pilots/blurryface/Message Man.mp3' },
                        { id: 8, title: 'Not Today', duration: '3:58', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/twenty one pilots/blurryface/Not Today.mp3' },
                        { id: 9, title: 'Polarize', duration: '3:46', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/twenty one pilots/blurryface/Polarize.mp3' },
                        { id: 10, title: 'Ride', duration: '3:34', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/twenty one pilots/blurryface/Ride.mp3' },
                        { id: 11, title: 'Stressed Out', duration: '3:22', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/twenty one pilots/blurryface/Stressed Out.mp3' },
                        { id: 12, title: 'Tear in My Heart', duration: '3:08', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/twenty one pilots/blurryface/Tear in My Heart.mp3' },
                        { id: 13, title: 'The Judge', duration: '4:57', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/twenty one pilots/blurryface/The Judge.mp3' },
                        { id: 14, title: 'We Don t Believe What s on TV', duration: '2:57', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/twenty one pilots/blurryface/We Don t Believe What s on TV.mp3' },
                    ]
                },
            ]
        },
        {
            id: 'billie-eilish',
            name: 'Billie Eilish',
            image: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/assets/artists/Billie Eilish/Billie Eilish.jpg',
            albums: [
                {
                    id: 'hit-me-hard-and-soft',
                    name: 'hit me hard and soft',
                    year: '2024', // Adicionei um ano para consistência
                    cover: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/assets/albums/Billie Eilish/hit me hard and soft/hit me hard and soft.jpg',
                    tracks: [
                        { id: 1, title: 'Billie Eilish - BIRDS OF A FEATHER (Official Music Video)', duration: '3:50', url: 'https://cdn.jsdelivr.net/gh/k4zzt/datamusic@main/musics/Billie Eilish/hit me hard and soft/Billie Eilish - BIRDS OF A FEATHER (Official Music Video).mp3' },
